...
export const inngest = new Inngest({ id: "DevTrack" });
...
// Inngest FUnction to detele user data
...
// Inngest function to save workspace memmber data to a  database
        ...
        await sendEmail({
            ...
            body: `<div style="max-width: 600px;">
                    ...
                    border-radius: 6px; margin-bottom: 30px;">
                          ...
                          (task.due_date).toLocaleDateString()}</p>
                          </div>
        ...
        if(new Date(task.due_date).toLocaleDateString() !== new Date().toLocaleDateString()){
            ...
            await step.run('check-if-task-is-completed',async () => {
                ...
                if(task.status !== "DONE"){
                    ...
                    <p style="font-size: 16px;">You've a taskdue in ${task.project.name}:</p>
                    <p style="font-size: 18px; font-weight: bold; color: #007bff;
                    margin: 8px 0;">${task.title}</p>
